...
namespace PmfApi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260901184516_FixInventoryUserForeignKey")]
    partial class FixInventoryUserForeignKey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PmfApi.Domain.Entities.Favorite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("PmfApi.Domain.Entities.Inventory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PmfApi.Domain.Entities.InventoryHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PmfApi.Domain.Entities.Location", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PmfApi.Domain.Entities.Medicine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PmfApi.Domain.Entities.PharmaciesSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PmfApi.Domain.Entities.Search", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PmfApi.Domain.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PmfApi.Domain.Entities.UserFeedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PmfApi.Domain.Entities.Inventory", b =>
                {
                    b.HasOne("PmfApi.Domain.Entities.Medicine", "Medicine")
                    ...
                    b.HasOne("PmfApi.Domain.Entities.UserFeedback", null)
                        .WithMany("Inventories")
            ...
            modelBuilder.Entity("PmfApi.Domain.Entities.InventoryHistory", b =>
                {
                    b.HasOne("PmfApi.Domain.Entities.Inventory", "Inventory")
                        .WithMany()
            ...
            modelBuilder.Entity("PmfApi.Domain.Entities.Location", b =>
                {
                    b.OwnsOne("PmfApi.Domain.Entities.Coordinate", "Coordinate", b1 =>
                        {
            ...
            modelBuilder.Entity("PmfApi.Domain.Entities.Pharmacy", b =>
                {
                    b.HasOne("PmfApi.Domain.Entities.Location", "Location")
                        .WithMany("Inventories")
                        .HasForeignKey("LocationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PmfApi.Domain.Entities.User", b =>
                {
                    ...
                    b.HasOne("PmfApi.Domain.Entities.Role", "Role")
                        .WithMany("Users")
